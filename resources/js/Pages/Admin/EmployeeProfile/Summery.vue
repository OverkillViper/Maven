...
const salaryCurrency = computed(() => (
    employee.job_location == 'Bangladesh'               ? 'BDT' :
...
<template>
    <div class="w-2/3 mx-auto flex flex-col gap-y-6">
        <div class="flex rounded-lg mt-24 p-6 bg-primary">
            <div class="basis-2/3">
                <div class="text-xl font-semibold text-white">{{ props.user.first_name }} {{ props.user.last_name }}</div>
                <div class="text-sm text-gray-200" v-if="employee.designation && employee.department">{{ employee.designation.title }}, {{ employee.department.name }}</div>
        ...
        <div class="border rounded-lg p-6">
            ...
            <div class="grid grid-cols-3 mt-4 gap-y-4">
                ...
                <InfoField label="Department"     :value="employee.department ? employee.department.name : null" />
                <InfoField label="Designation"    :value="employee.designation ? employee.designation.title : null" />
